      ...
      <main className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-[#bf953f] to-[#aa771c] shadow-lg shadow-[#bf953f]/20">
              <Sparkles className="w-8 h-8 text-black" />
            </div>
            <div>
              <h1 className="text-3xl md:text-5xl font-black tracking-tighter bg-gradient-to-r from-[#bf953f] via-[#fcf6ba] to-[#aa771c] bg-clip-text text-transparent uppercase italic leading-none">
                AI ULTRA PRO
              </h1>
